...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'cjm_graph_plugin_sqlite.plugin': { 'cjm_graph_plugin_sqlite.plugin.SQLiteGraphPlugin': ( 'plugin.html#sqlitegraphplugin',
                                                ...
                                                'cjm_graph_plugin_sqlite.plugin.SQLiteGraphPlugin._connect': ( 'plugin.html#sqlitegraphplugin._connect',
                                                                                                               'cjm_graph_plugin_sqlite/plugin.py'),
                                                'cjm_graph_plugin_sqlite.plugin.SQLiteGraphPlugin._default_db_path': ( 'plugin.html#sqlitegraphplugin._default_db_path',
                                                                                                                       'cjm_graph_plugin_sqlite/plugin.py'),
                                                ...
                                                'cjm_graph_plugin_sqlite.plugin.SQLiteGraphPluginConfig': ( 'plugin.html#sqlitegraphpluginconfig',
                                                                                                            'cjm_graph_plugin_sqlite/plugin.py'),
                                                'cjm_graph_plugin_sqlite.plugin.integrity_check': ( 'plugin.html#integrity_check',
                                                                                                    'cjm_graph_plugin_sqlite/plugin.py'),
                                                'cjm_graph_plugin_sqlite.plugin.query_edges': ( 'plugin.html#query_edges',
                                                                                                'cjm_graph_plugin_sqlite/plugin.py'),
                                                'cjm_graph_plugin_sqlite.plugin.query_nodes': ( 'plugin.html#query_nodes',
                                                                                                'cjm_graph_plugin_sqlite/plugin.py'),
                                                'cjm_graph_plugin_sqlite.plugin.raw_query': ( 'plugin.html#raw_query',
                                                                                              'cjm_graph_plugin_sqlite/plugin.py')},
            'cjm_graph_plugin_sqlite.query_translation': { 'cjm_graph_plugin_sqlite.query_translation._escape_like': ( 'query_translation.html#_escape_like',
                                                                                                                       'cjm_graph_plugin_sqlite/query_translation.py'),
                                                           'cjm_graph_plugin_sqlite.query_translation._json_path': ( 'query_translation.html#_json_path',
                                                                                                                     'cjm_graph_plugin_sqlite/query_translation.py'),
                                                           'cjm_graph_plugin_sqlite.query_translation._order_limit_sql': ( 'query_translation.html#_order_limit_sql',
                                                                                                                           'cjm_graph_plugin_sqlite/query_translation.py'),
                                                           'cjm_graph_plugin_sqlite.query_translation._predicate_sql': ( 'query_translation.html#_predicate_sql',
                                                                                                                         'cjm_graph_plugin_sqlite/query_translation.py'),
                                                           'cjm_graph_plugin_sqlite.query_translation._relation_exists_sql': ( 'query_translation.html#_relation_exists_sql',
                                                                                                                               'cjm_graph_plugin_sqlite/query_translation.py'),
                                                           'cjm_graph_plugin_sqlite.query_translation._source_match_sql': ( 'query_translation.html#_source_match_sql',
                                                                                                                            'cjm_graph_plugin_sqlite/query_translation.py'),
                                                           'cjm_graph_plugin_sqlite.query_translation.translate_edge_query': ( 'query_translation.html#translate_edge_query',
                                                                                                                               'cjm_graph_plugin_sqlite/query_translation.py'),
                                                           'cjm_graph_plugin_sqlite.query_translation.translate_node_query': ( 'query_translation.html#translate_node_query',
                                                                                                                               'cjm_graph_plugin_sqlite/query_translation.py')}}}
